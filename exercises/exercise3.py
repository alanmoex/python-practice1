...
# COMPLETAR - INICIO
comparar_nombre_y_edad = (persona_01 == persona_02) & (edad_01 != edad_02)
# COMPLETAR - FIN
...
# COMPLETAR - INICIO
comparar_marca_y_modelo = (marca_del_auto != "Ford") & (modelo_de_auto <= 2000)
# COMPLETAR - FIN
...
# COMPLETAR - INICIO
comparar_frutas = bananas < naranjas/2 < 2*manzanas <= peras*peras
# COMPLETAR - FIN
